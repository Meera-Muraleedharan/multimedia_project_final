...
bg = pygame.image.load('AsteroidsTut/asteroidsPics/starbg.png')
alienImg = pygame.image.load('AsteroidsTut/asteroidsPics/alienShip.png')
playerRocket = pygame.image.load('AsteroidsTut/asteroidsPics/spaceRocket.png')
star = pygame.image.load('AsteroidsTut/asteroidsPics/star.png')
asteroid50 = pygame.image.load('AsteroidsTut/asteroidsPics/asteroid50.png')
asteroid100 = pygame.image.load('AsteroidsTut/asteroidsPics/asteroid100.png')
asteroid150 = pygame.image.load('AsteroidsTut/asteroidsPics/asteroid150.png')

shoot = pygame.mixer.Sound('AsteroidsTut/sounds/shoot.wav')
bangLargeSound = pygame.mixer.Sound('AsteroidsTut/sounds/bangLarge.wav')
bangSmallSound = pygame.mixer.Sound('AsteroidsTut/sounds/bangSmall.wav')
shoot.set_volume(.25)
